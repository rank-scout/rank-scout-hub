...
export function buildSeoRedirectCloudflareCsv(redirects: SeoRedirect[], siteUrl = "https://rank-scout.com") {
...
export function downloadSeoRedirectCloudflareCsv(redirects: SeoRedirect[], fileName = "cloudflare-bulk-redirects.csv", siteUrl = "https://rank-scout.com") {
