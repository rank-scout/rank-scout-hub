...
export const defaultHomeContent = {
  hero: {
    ...
    subtitle: "Suche & finde die besten Tools für deinen Erfolg. Vergleiche, entdecke und nutze die Top-Angebote aus KI, Software und Lifestyle. Unabhängig geprüft.",
