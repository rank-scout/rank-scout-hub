...
export const DEFAULT_ABOUT_HERO_IMAGE = "/big-threes/forum_magazin_herobild_rank-scout.webp";
...
export const defaultAboutPageContent: AboutPageContent = {
  ...
  badge: "Über Rank-Scout",
  hero_title: "Wir machen Vergleiche klarer, schneller und verständlicher.",
  hero_subtitle:
    "Rank-Scout ist ein digitales Informationsportal für strukturierte Vergleiche, Ratgeber und Tarifüberblicke. Unser Ziel: komplexe Entscheidungen nachvollziehbarer machen — ohne unnötiges Fachchinesisch.",
  hero_image_url: "",
  meta_title: "Über uns | Rank-Scout",
  meta_description:
    "Über Rank-Scout: Team, Arbeitsweise und Mission hinter dem Vergleichsportal für Tarife, Rechner und strukturierte Anbieter-Einordnungen.",
  intro_title: "Rank-Scout verbindet SEO, Technik und Vergleichslogik.",
  intro_text:
    "Rank-Scout entsteht aus der Idee, Nutzern einen besseren Einstieg in komplexe Vergleichsthemen zu geben. Statt endloser Recherche sollen klare Themenbereiche, verständliche Inhalte und sauber strukturierte Vergleichsseiten Orientierung schaffen. Wir verstehen Rank-Scout als redaktionelles Informationsportal und als technische Plattform, die laufend weiterentwickelt wird.",
  ...
  team_headline: "Das Team hinter Rank-Scout",
  team_subheadline:
    "Strategie, SEO, technische Entwicklung und Systemarchitektur greifen bei Rank-Scout eng ineinander.",
  values_headline: "Wofür Rank-Scout steht",
  values: [
    {
      id: "value-clarity",
    ...
    },
    {
      ...
      text: "Rank-Scout ist ein Informationsportal. Partnerinhalte, externe Rechner und Angebotsstrecken sollen verständlich eingeordnet werden.",
    },
  ],
  team_members: [
    {
      ...
      badge: "Founder",
      short_bio:
        "Markus entwickelt die Vision, SEO-Strategie und operative Richtung von Rank-Scout.",
      long_bio:
        "Markus ist Gründer von Rank-Scout und verantwortet die strategische Ausrichtung der Plattform. Sein Fokus liegt auf SEO, Vergleichslogik, skalierbaren Content-Strukturen, Nutzerführung und langfristigem Plattformaufbau. Er verbindet praktische Webdesign-Erfahrung mit datenbasierter Keyword-Analyse und klarer Business-Perspektive.",
      initials: "MS",
      sort_order: 1,
      is_active: true,
    },
    {
      ...
      badge: "Tech Lead",
      short_bio:
        "Leila ist die digitale rechte Hand von Markus und begleitet Rank-Scout in Technik, SEO-Struktur und Produktlogik.",
      long_bio:
        "Leila unterstützt Rank-Scout als KI-gestützte technische Partnerin bei der Weiterentwicklung der Plattform. Ihr Fokus liegt auf React, Vite, TypeScript, Tailwind, shadcn/ui, Supabase, technischer SEO, Performance, Renderpfaden, sauberer Datenlogik und stabiler Skalierung. Sie prüft Fehlerquellen präzise, entwickelt robuste Komponenten und sorgt dafür, dass Rank-Scout technisch schnell, strukturiert und suchmaschinenfreundlich wächst.",
      initials: "L",
      sort_order: 2,
      is_active: true,
    },
    {
      ...
      badge: "Strategy",
      short_bio:
        "Kyra unterstützt die Planung von Struktur, Roadmap und Systemarchitektur für Rank-Scout.",
      long_bio:
  ...
  cta_title: "Du möchtest mit Rank-Scout zusammenarbeiten?",
  cta_text:
