...
const DEFAULT_META_TITLE = "Forum & Ratgeber 2026 | Rank-Scout";
const DEFAULT_META_DESCRIPTION =
  "Rank-Scout Forum mit Ratgebern, Vergleichen und Analysen. Beiträge nach Themen durchsuchen und aktuelle Artikel schnell finden.";
...
const ForumThreadCard = ({ thread }: { thread: PublicForumThread }) => {
  const excerpt =
    ...
    "Lies den vollständigen Beitrag mit kompakten Fakten, Vergleichen und Einordnung in unserem Rank-Scout Forum.";
...
export default function Forum() {
  ...
  const metaTitle = selectedCategory
    ? truncate(`${selectedCategory.name} Forum & Ratgeber | Rank-Scout`, 60)
    : DEFAULT_META_TITLE;

  const metaDescription = selectedCategory
    ? truncate(
        `${selectedCategory.name} Beiträge, Vergleiche und Analysen im Rank-Scout Forum. Mobil optimiert, schnell filterbar und direkt lesbar.`,
        155,
      )
