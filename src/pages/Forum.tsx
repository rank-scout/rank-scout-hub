            ...
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-slate-600 max-w-2xl mx-auto leading-relaxed">
                {categoryFilter !== "all" && activeCategoryData?.description
                  ...
                  : "Diskutiere mit Experten, teile deine Erfahrungen und finde Antworten auf deine Fragen."}
              </p>
        ...
        <div className="container mx-auto px-4 py-8 md:py-12">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-8 space-y-6">
              ...
              <div className="bg-white p-4 rounded-xl border shadow-sm flex flex-col md:flex-row gap-4 items-center justify-between sticky top-20 z-20">
            ...
            <div className="lg:col-span-4 space-y-6">
              ...
              {bannerConfig.isActive && bannerConfig.imageUrl && (
                <a 
                  href={bannerConfig.linkUrl || "#"} 
                  target={bannerConfig.linkUrl?.startsWith("http") ? "_blank" : "_self"}
                ...
                >
                  <img 
                    ...
                    alt={bannerConfig.title || "Anzeige"} 
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/40 to-transparent p-6 flex flex-col justify-end text-white">
                     {bannerConfig.title && <h4 className="font-bold text-lg leading-tight mb-1">{bannerConfig.title}</h4>}
                     {bannerConfig.description && <p className="text-xs text-white/80 line-clamp-2 mb-3">{bannerConfig.description}</p>}
                     {bannerConfig.ctaText && (
                       <span className="inline-flex items-center text-xs font-bold bg-white/20 hover:bg-white/30 backdrop-blur-sm px-3 py-1.5 rounded-full w-fit transition-colors">
                         {bannerConfig.ctaText} <ArrowRight className="ml-1 w-3 h-3"/>
                       </span>
                     )}
                  </div>
