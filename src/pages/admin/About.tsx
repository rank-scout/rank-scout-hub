...
const emptyMember = (sortOrder: number): AboutTeamMember => ({
  ...
  long_bio: "Ausführlichere Beschreibung der Person und ihrer Aufgaben bei Rank-Scout.",
  image_url: "",
  initials: "NP",
...
const emptyValue = (sortOrder: number): AboutValueCard => ({
  ...
  text: "Kurze Erklärung, wofür Rank-Scout an dieser Stelle steht.",
});
          ...
          <Card className="border-slate-200 bg-white shadow-sm">
            <CardHeader className="flex flex-row items-center justify-between gap-4">
              <div>
                ...
                <CardDescription>Diese Kacheln erklären kurz, wofür Rank-Scout steht.</CardDescription>
              </div>
