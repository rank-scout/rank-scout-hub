          ...
          <div className="space-y-16">
            ...
            <section>
              ...
              <div className="bg-slate-50 p-6 rounded-xl border border-slate-100 text-slate-700 space-y-3">
                <p>Rank-Scout stellt eine redaktionelle Informations- und Vergleichsplattform für Software, digitale Dienstleistungen, Finanzprodukte und Versicherungen bereit.</p>
