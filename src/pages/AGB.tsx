  ...
  return (
    <div className="min-h-screen flex flex-col bg-white font-sans text-slate-900">
      <Helmet>
        ...
        <meta
          name="description"
          content="Allgemeine Geschäftsbedingungen für die Nutzung von Rank-Scout sowie Hinweise zu eingebundenen Vergleichsrechnern, Formularen und externen Partnerdiensten."
        />
          ...
          <div className="space-y-16">
            <section>
              ...
              <div className="article-content article-content--legal max-w-none text-slate-700">
                ...
                <p>
                  Anbieter und Betreiber von Rank-Scout ist der jeweils im Impressum genannte Seitenbetreiber.
            ...
            <section>
              ...
              <div className="bg-slate-50 p-6 rounded-xl border border-slate-100 text-slate-700 space-y-4">
                <p>
                  Rank-Scout ist eine redaktionelle Informations-, Recherche- und Vergleichsplattform für ausgewählte
                ...
                <p>
                  Rank-Scout stellt eigene Inhalte, redaktionelle Übersichten, Ratgeber, FAQ-Inhalte, neutrale
                ...
                <p>
                  Soweit auf Rank-Scout Vergleichsrechner, Formulare, iFrames, Tarifstrecken, Kurzrechner,
            ...
            <section>
              ...
              <div className="space-y-6 text-slate-700">
                <div className="p-6 rounded-xl border border-slate-100 bg-slate-50 space-y-3">
                  <p>
                    Rank-Scout tritt – soweit nicht ausdrücklich anders angegeben – nicht selbst als Versicherer,
                  ...
                  <p>
                    Rank-Scout selbst wird nicht Vertragspartei eines über externe Vergleichsrechner, Formulare oder
                ...
                <div className="p-6 rounded-xl border border-secondary/20 bg-secondary/5 space-y-4">
                  ...
                  <p>
                    Sofern auf Rank-Scout Vergleichsrechner oder Formulare von <strong>TARIFCHECK24 GmbH</strong> bzw.
            ...
            <section>
              ...
              <div className="article-content article-content--legal max-w-none text-slate-700">
                ...
                <p>
                  Rank-Scout ist nicht verpflichtet, den gesamten Markt, alle Anbieter, sämtliche Tarife oder jede am
            ...
            <section>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="p-6 rounded-xl border border-red-100 bg-red-50/50">
                  ...
                  <p className="text-sm text-red-800">
                    Rank-Scout bemüht sich um aktuelle und sorgfältig aufbereitete Inhalte. Eine Gewähr für Richtigkeit,
              ...
              <div className="article-content article-content--legal max-w-none text-slate-700 mt-6">
                ...
                <p>
                  Rank-Scout schuldet keinen bestimmten wirtschaftlichen, finanziellen, versicherungsbezogenen oder
                  vertraglichen Erfolg. Insbesondere übernimmt Rank-Scout keine Haftung dafür, dass über eingebundene
            ...
            <section className="bg-primary/5 p-8 rounded-2xl border border-primary/10">
              ...
              <div className="mt-12 pt-8 border-t border-slate-200 grid grid-cols-1 md:grid-cols-[minmax(0,1fr)_auto] gap-4 md:gap-6 items-start md:items-center">
                ...
                <a
                  href="mailto:hello@rank-scout.com"
                ...
                >
                  ...
                  <span className="whitespace-nowrap">hello@rank-scout.com</span>
                </a>
              </div>
            </section>
          </div>
