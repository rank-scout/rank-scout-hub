...
export default function ProjectListEmbed({ projects, categoryName = "", theme = "DATING" }: ProjectListEmbedProps) {
              ...
              <div className="flex flex-col md:flex-row gap-6 items-start md:items-center">
                <div className="flex-shrink-0">
                  {project.logo_url ? (
                    ...
                    <div className={`w-16 h-16 md:w-20 md:h-20 rounded-xl ${themeClasses.bg} flex items-center justify-center shadow-inner`}>
                  ...
                  <div className="flex items-start justify-between gap-4 mb-2">
                    ...
                    {project.rating && (
                      <div className="flex items-center gap-1 flex-shrink-0 bg-yellow-500/10 px-2 py-1 rounded-lg">
                        ...
                        <span className="font-semibold text-yellow-400">{Number(project.rating).toFixed(1)}</span>
                      </div>
                    )}
                  </div>
                ...
                <div className="flex-shrink-0 w-full md:w-auto">
                  <Link to={`/go/${project.slug}`}>
                    <Button className={`w-full md:w-auto gap-2 shadow-lg ${index === 0 ? themeClasses.button + ' text-white shadow-primary/25' : ''}`}>
                      Jetzt testen
