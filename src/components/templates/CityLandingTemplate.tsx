...
export default function CityLandingTemplate({
  ...
  const defaultSettings = {
    show_top3_dating_apps: false,
    show_singles_in_der_naehe: false,
    show_chat_mit_einer_frau: false,
    show_online_dating_cafe: false,
    show_bildkontakte_login: false,
    show_18plus_hint_box: false,
  };
      ...
      <main className="pt-16">
          ...
          <div className="container mx-auto px-4 relative z-10">
            ...
            <div className="max-w-4xl mx-auto text-center">
              <div className="flex items-center justify-center gap-2 mb-4">
                ...
                <span
                  className={`font-display font-semibold uppercase tracking-wider ${theme.text}`}
                >
              ...
              <h1 className="font-display font-bold text-4xl md:text-5xl lg:text-6xl text-foreground mb-6 leading-tight">
                {category.hero_headline ||
                  `Finde Singles in ${category.name} & Umgebung`}
              </h1>
              ...
              <Button
                size="lg"
                className="bg-amber-500 hover:bg-amber-400 text-black font-semibold gap-2 px-8 py-6 text-lg shadow-lg shadow-amber-500/25"
              >
              ...
              <p className="mt-4 text-sm text-muted-foreground flex items-center justify-center gap-2">
                ...
                Für Stadt & Region {category.name} aufbereitet
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            <div className="flex flex-wrap items-center justify-center gap-6 md:gap-12 text-sm">
              <div className="flex items-center gap-2.5 text-foreground">
                ...
                <span className="font-medium">Ausgewählte Anbieter</span>
              </div>
            ...
            <div className="container mx-auto px-4">
              {category.banner_override ? (
                <div
                  ...
                  dangerouslySetInnerHTML={{ __html: category.banner_override }}
                />
              ) : isDev ? (
              ...
              <div className="max-w-4xl mx-auto">
                <div className="flex items-start justify-between mb-4">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Praktische interne Links passend zu „{category.name}“.
                    </p>
                  </div>
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  {navSettings.show_top3_dating_apps && (
                    <Link
                      to="/top3-dating-apps"
                      className="inline-flex items-center gap-2 px-3 py-2 rounded-full border border-border bg-card hover:bg-muted transition-colors text-sm"
                    >
                      ⭐ Top3 Dating Apps
                    </Link>
                  )}
                ...
                {/* 18+ Hinweis im Main-Hub entfernt */}
              </div>
            </div>
          </section>
        )}
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto">
                Unsere Redaktion hat Anbieter für {category.name} strukturiert
                verglichen.
              </p>
            </div>
                  ...
                  <div className="flex flex-col md:flex-row gap-6 items-start md:items-center">
                    <div className="flex-shrink-0">
                      {project.logo_url ? (
                        ...
                        <div
                          className={`w-16 h-16 md:w-20 md:h-20 rounded-xl ${theme.bg} flex items-center justify-center shadow-inner`}
                        >
                      ...
                      <Link to={`/go/${project.slug}`}>
                        <Button
                          className={`w-full md:w-auto gap-2 shadow-lg ${
                            index === 0
                              ? theme.button + " text-white shadow-primary/25"
                              : ""
                          }`}
                        >
                          Jetzt testen
            ...
            <div className="container mx-auto px-4">
              <div
                ...
                dangerouslySetInnerHTML={{
                  __html: sanitizeCmsHtml(category.long_content_bottom),
                }}
              />
            </div>
          </section>
        ...
        <section className="py-12 bg-muted/20">
          <div className="container mx-auto px-4 text-center">
            <Link
              to="/kategorien"
              className={`inline-flex items-center gap-2 ${theme.text} hover:underline font-medium`}
            >
