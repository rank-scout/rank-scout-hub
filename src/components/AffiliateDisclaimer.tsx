  ...
  return (
    <div className="bg-slate-50 border border-slate-200 rounded-lg p-4 my-8 flex items-start gap-3">
      ...
      <div className="text-sm text-slate-500 leading-relaxed m-0">
        <strong>Transparenz-Hinweis:</strong> Rank-Scout ist ein redaktionelles Informationsportal und tritt als Tippgeber auf. Wir führen keine Anlage- oder Versicherungsberatung durch. 
        <br/><br/>
