...
export const BigThreeSection = () => {
  ...
  const scrollSlider = (direction: "prev" | "next") => {
    ...
    const firstCard = slider.querySelector<HTMLElement>(".rank-scout-category-card");
  ...
  return (
    <section id="bereiche" className="py-24 md:py-28 relative overflow-hidden bg-white">
      <style>{`
        .rank-scout-category-slider {
          scrollbar-width: none;
          -ms-overflow-style: none;
        }

        .rank-scout-category-slider::-webkit-scrollbar {
          display: none;
        }

        .rank-scout-category-card {
          flex: 0 0 84%;
        }
      ...
      <div className="container px-4 mx-auto relative z-10">
        ...
        <div className="relative -mx-4 px-4 md:mx-0 md:px-0">
          ...
          <div
            ref={sliderRef}
            className="rank-scout-category-slider flex gap-6 overflow-x-auto pb-2 scroll-smooth snap-x snap-mandatory overscroll-x-contain"
            aria-label="Rank-Scout Vergleichskategorien"
          >
            {items.map((item) => {
